    ...
    <div className="flex flex-col gap-12 mx-2  p-6">
      ...
      <div className="container1">
        ...
        <div className="md:w-4/5 md:pl-6">
          ...
          <button className="bg-green-800 text-white font-sans px-3 py-2">Explore Collection</button>
        </div>
      </div>
      ...
      <div className="container1">
        ...
        <div className="md:w-4/5 md:pr-12">
          ...
          <button className=" text-white bg-green-800 px-3 py-2 font-sans">Explore Collection</button>
        </div>
      </div>
    </div>
    </>
